...
//This will store current file path for plugin list option show, it will use in constant.php file
        ...
        if ( get_transient( 'wcpfc-admin-notice' ) ) {
            ...
            if ( wcpffc_fs()->is__premium_only() ) {
                if ( wcpffc_fs()->can_use_premium_code() ) {
                    echo  sprintf( wp_kses( __( '<strong>WooCommerce Extra Fees Plugin is successfully installed and ready to go.</strong>', 'woocommerce-conditional-product-fees-for-checkout' ), array(
                        'strong' => array(),
