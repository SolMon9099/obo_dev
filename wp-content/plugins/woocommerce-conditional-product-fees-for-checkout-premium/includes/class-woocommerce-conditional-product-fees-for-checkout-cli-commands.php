...
class DS_Command_Line {
    ...
    public function enable_fees( $args, $assoc_args ){
        ...
        WP_CLI::success( esc_html__( 'All fees has been enabled...!', 'woocommerce-conditional-product-fees-for-checkout' ) );
    }
    ...
    public function disable_fees( $args, $assoc_args ){
        ...
        WP_CLI::success( esc_html__( 'All fees has been disabled...!', 'woocommerce-conditional-product-fees-for-checkout' ) );
    }
    ...
    public function delete_fees( $args, $assoc_args ) {
        ...
        WP_CLI::success( esc_html__( 'All fees has been deleted...!', 'woocommerce-conditional-product-fees-for-checkout' ) );
    }
     ...
     */
    public function import_fee( $args, $assoc_args ){
     ...
     */
    public function export_fee( $args, $assoc_args ) {
