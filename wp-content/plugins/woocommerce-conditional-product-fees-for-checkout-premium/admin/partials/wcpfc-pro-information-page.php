				...
				<tr>
					...
					<td class="fr-2">
						<ul style="margin: 0px;">
							...
							<li><a target="_blank"
							       href="<?php echo esc_url( "https://docs.thedotstore.com/category/191-premium-plugin-settings" ); ?>"><?php esc_html_e( 'Guide Documentation', 'woocommerce-conditional-product-fees-for-checkout' ); ?></a>
							</li>
							<li><a target="_blank"
                            ...
                            <li><a target="_blank"
							       href="<?php echo esc_url( "https://docs.thedotstore.com/article/672-custom-filters" ); ?>"><?php esc_html_e( 'Custom Filters', 'woocommerce-conditional-product-fees-for-checkout' ); ?></a>
							</li>
						</ul>
					</td>
				</tr>
