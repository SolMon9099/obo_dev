...
final class Geolocation extends Component {
	...
	public function enqueue_scripts() {
		if ( get_option( 'hp_geolocation_provider' ) === 'mapbox' ) {
			...
			wp_enqueue_script( 'overlapping_maps', 
	'https://cdnjs.cloudflare.com/ajax/libs/OverlappingMarkerSpiderfier/1.0.3/oms.min.js?spiderfier_callback=initMap',
	 array('google-maps'), '1.0.0', true );
		}
	}
